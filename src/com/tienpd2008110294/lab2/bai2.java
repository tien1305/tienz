...
public class bai2 {
    public static void main(String[] args) {
        ...
        System.out.print("Nhập vào hệ số a: ");int a = in.nextInt();
        System.out.print("Nhập vào hệ số b: ");int b = in.nextInt();
        System.out.print("Nhập vào hệ số c: ");int c = in.nextInt();
        System.out.printf("PT có dạng %dx^2 + %dx + %d = 0",a,b,c);
        if(a==0)
            bac1(b,c);
        else
        {
